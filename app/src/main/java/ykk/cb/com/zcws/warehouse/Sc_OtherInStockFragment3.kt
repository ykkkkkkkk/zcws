 ...
 * 作者：ykk
 */
class Sc_OtherInStockFragment3 : BaseFragment() {
    ...
    private class MyHandler(activity: Sc_OtherInStockFragment3) : Handler() {
        private val mActivity: WeakReference<Sc_OtherInStockFragment3>
