...
import ykk.cb.com.zcws.warehouse.adapter.OutInStockSearchFragment1_OtherInStock_Adapter
import ykk.cb.com.zcws.warehouse.adapter.OutInStockSearchFragment3_PurInStock_Adapter
 ...
 * 作者：ykk
 */
class OutInStockSearchFragment3_PurInStock : BaseFragment() {
    ...
    private class MyHandler(activity: OutInStockSearchFragment3_PurInStock) : Handler() {
        private val mActivity: WeakReference<OutInStockSearchFragment3_PurInStock>
