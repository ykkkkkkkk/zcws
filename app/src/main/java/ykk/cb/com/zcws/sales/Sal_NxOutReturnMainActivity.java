 ...
 *  内销帐号退货Main
 */
public class Sal_NxOutReturnMainActivity extends BaseActivity {
    ...
    private Sal_NxOutReturnMainActivity context = this;
...
//    private Customer customer; // 客户
    ...
    public int setLayoutResID() {
        return R.layout.sal_nx_out_return_main;
    }
...
//        fragment2.setArguments(bundle2); // 传参数
        Sal_NxOutReturnFragment1 fragment1 = new Sal_NxOutReturnFragment1();
