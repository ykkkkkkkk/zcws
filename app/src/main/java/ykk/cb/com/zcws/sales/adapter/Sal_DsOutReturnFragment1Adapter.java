...
public class Sal_DsOutReturnFragment1Adapter extends BaseArrayRecyclerAdapter<ScanningRecord> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Sal_DsOutReturnFragment1Adapter(Activity context, List<ScanningRecord> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.sal_ds_out_return_fragment1_item;
    }
