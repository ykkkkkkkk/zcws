 ...
 * 设置
 */
public class MainTabFragment6 extends BaseFragment implements IDownloadContract.View {

//    Unbinder unbinder;

    private MainTabFragment6 context = this;
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<MainTabFragment6> mActivity;

        public MyHandler(MainTabFragment6 activity) {
            mActivity = new WeakReference<MainTabFragment6>(activity);
        }

        public void handleMessage(Message msg) {
            MainTabFragment6 m = mActivity.get();
            if (m != null) {
                m.hideLoadDialog();
                switch (msg.what) {
                    case SUCC1: // 得到更新信息
