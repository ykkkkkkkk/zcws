...
import kotlinx.android.synthetic.main.ware_icinvbackup2_main.*
...
//        viewPager.setScanScroll(false); // 禁止左右滑动
    ...
    fun onViewClicked(view: View) {
        ...
        when (view.id) {
            R.id.btn_close -> { // 关闭
                if (fragment1.checkDatas.size > 0) {
