 ...
 * 作者：ykk
 */
class Sc_OtherInStockFragment2 : BaseFragment() {
    ...
    private class MyHandler(activity: Sc_OtherInStockFragment2) : Handler() {
        private val mActivity: WeakReference<Sc_OtherInStockFragment2>
