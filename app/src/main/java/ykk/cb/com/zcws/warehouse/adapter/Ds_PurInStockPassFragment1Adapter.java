...
public class Ds_PurInStockPassFragment1Adapter extends BaseArrayRecyclerAdapter<Icstockbillentry> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Ds_PurInStockPassFragment1Adapter(Activity context, List<Icstockbillentry> datas) {
        super(datas);
