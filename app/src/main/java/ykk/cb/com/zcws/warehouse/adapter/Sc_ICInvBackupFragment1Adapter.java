...
public class Sc_ICInvBackupFragment1Adapter extends BaseArrayRecyclerAdapter<ICInvBackup> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Sc_ICInvBackupFragment1Adapter(Activity context, List<ICInvBackup> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.ware_sc_check_fragment1_item;
    }
    ...
    public interface MyCallBack {
        void onClick_num(View v, ICInvBackup entity, int position);
    }
