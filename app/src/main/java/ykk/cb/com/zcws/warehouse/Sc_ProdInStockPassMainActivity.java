...
public class Sc_ProdInStockPassMainActivity extends BaseActivity {
    ...
    private Sc_ProdInStockPassMainActivity context = this;
    private static final String TAG = "Sc_PurInStockPassMainActivity";
...
//    private boolean isPair; // 蓝牙是否打印了
    ...
    private Sc_ProdInStockPassFragment1 fragment1 = new Sc_ProdInStockPassFragment1();
//    private Customer customer; // 客户

    @Override
    public int setLayoutResID() {
        return R.layout.ware_sc_prod_instock_pass_main;
    }
