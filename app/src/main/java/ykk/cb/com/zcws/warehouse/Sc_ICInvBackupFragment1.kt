...
import kotlinx.android.synthetic.main.ware_sc_icinvbackup_fragment1.*
import okhttp3.*
...
import ykk.cb.com.zcws.warehouse.adapter.Sc_ICInvBackupFragment1Adapter
 ...
 * 作者：ykk
 */
class Sc_ICInvBackupFragment1 : BaseFragment() {
    ...
    private val SUBMIT = 201
    private val UNSUBMIT = 501
    ...
    private var mAdapter: Sc_ICInvBackupFragment1Adapter? = null
    private val checkDatas = ArrayList<ICInvBackup>()
    private var okHttpClient: OkHttpClient? = null
    private var user: User? = null
    private var mContext: Activity? = null
    private var parent: Sc_ICInvBackupMainActivity? = null
    ...
    private class MyHandler(activity: Sc_ICInvBackupFragment1) : Handler() {
        private val mActivity: WeakReference<Sc_ICInvBackupFragment1>
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_sc_icinvbackup_fragment1, container, false)
    }

    override fun initView() {
        mContext = getActivity()
        parent = mContext as Sc_ICInvBackupMainActivity

        recyclerView.addItemDecoration(DividerItemDecoration(mContext, DividerItemDecoration.VERTICAL))
        recyclerView.layoutManager = LinearLayoutManager(mContext)
        mAdapter = Sc_ICInvBackupFragment1Adapter(mContext, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(Sc_ICInvBackupFragment1Adapter.MyCallBack { v, entity, position ->
            curPos = position
