...
public class Sal_ScOutFragment1Adapter extends BaseArrayRecyclerAdapter<ScanningRecord> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Sal_ScOutFragment1Adapter(Activity context, List<ScanningRecord> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.sal_sc_out_fragment1_item;
    }
