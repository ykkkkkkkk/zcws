 ...
 * 作者：ykk
 */
class OutInStockSearchFragment1_OtherInStock : BaseFragment() {
    ...
    private class MyHandler(activity: OutInStockSearchFragment1_OtherInStock) : Handler() {
        private val mActivity: WeakReference<OutInStockSearchFragment1_OtherInStock>
