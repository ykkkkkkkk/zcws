...
import ykk.cb.com.zcws.warehouse.adapter.OutInStockSearchFragment2_PurReceiveInStock_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment2_PurReceiveInStock : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment2_PurReceiveInStock_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment2_PurReceiveInStock) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment2_PurReceiveInStock>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment2_PurReceiveInStock_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment2_PurReceiveInStock_Adapter.MyCallBack {
