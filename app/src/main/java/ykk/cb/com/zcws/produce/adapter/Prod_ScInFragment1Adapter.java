...
public class Prod_ScInFragment1Adapter extends BaseArrayRecyclerAdapter<ScanningRecord> {
    private DecimalFormat df = new DecimalFormat("#.######");
    private Activity context;
    private MyCallBack callBack;

    public Prod_ScInFragment1Adapter(Activity context, List<ScanningRecord> datas) {
        super(datas);
