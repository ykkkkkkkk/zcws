...
import kotlinx.android.synthetic.main.ware_transfer_pickinglist_fragment3.*
...
import ykk.cb.com.zcws.warehouse.adapter.Transfer_PickingList_Fragment3_Adapter
 ...
 * 作者：ykk
 */
class Transfer_PickingList_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Transfer_PickingList_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Transfer_PickingList_Fragment3) : Handler() {
        private val mActivity: WeakReference<Transfer_PickingList_Fragment3>
...
//                        m.parent!!.fragment1.reset() // 重置
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_transfer_pickinglist_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = Transfer_PickingList_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Transfer_PickingList_Fragment3_Adapter.MyCallBack {
...
//            }
    ...
    private fun run_findEntryList() {
        ...
        val formBody = FormBody.Builder()
                ...
                .add("columnName", "C.FNumber,D.FNumber") // 根据库位顺序号、物料代码排序
                .build()
